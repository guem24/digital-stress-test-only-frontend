...
class Main extends React.Component {
    ...
    render() {
        const pageKey = `${this.state.studyPagesSequence[this.state.pageIndex]}-${this.state.pageIndex}-${this.state.slideIndex}`;
        return (
            <div className="App">
                <div className="container ">
                    <div className="row justify-content-md-center">
                        <div className="col text-center" key={pageKey} style={{
