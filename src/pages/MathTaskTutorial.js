...
export default class MathTaskTutorial extends React.Component{
    ...
    render() {
        return <>
            {this.props.activeSlide === 'transition' && (
                <Slide direction="right" in={this.props.activeSlide === 'transition'} mountOnEnter unmountOnExit timeout={300}>
                    <Transition
            ...
            {this.props.activeSlide === 'vas' && (
                <Slide direction="right" in={this.props.activeSlide === 'vas'} mountOnEnter unmountOnExit timeout={300}>
                    <VisualAnalogueScale
            ...
            {this.props.activeSlide === 'comparison' && (
                <Slide direction="right" in={this.props.activeSlide === 'comparison'} mountOnEnter unmountOnExit timeout={300}>
                    <GenderAndAge
                        handleNext={this.props.handleNext}
            ...
            {this.props.activeSlide === 'countdown' && (
                <Slide direction="right" in={this.props.activeSlide === 'countdown'} mountOnEnter unmountOnExit timeout={300}>
                    <CountdownBeforeTask
